...
public:
	...
	void OnInit () {
		...
		{ Block Start( "Additional User Init" );
			...
			shaders[ "Draw" ] = computeShader( "./src/projects/CellularAutomata/GoL/shaders/draw.cs.glsl" ).shaderHandle;
			shaders[ "Update" ] = computeShader( "./src/projects/CellularAutomata/GoL/shaders/update.cs.glsl" ).shaderHandle;
