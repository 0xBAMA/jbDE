...
// add precomputed sim textures:
	// steepness texture for scaling movement speed
	// distance + direction to nearest obstacle
...
void main() {
	...
	// data[ index ].position.xy = data[ index ].position.xy + vec2( 0.001f );
