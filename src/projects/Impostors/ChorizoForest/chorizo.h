...
public:
	...
	void OnInit () {
		ZoneScoped;
		{
			...
			shaders[ "Draw" ] = computeShader( "./src/projects/Impostors/ChorizoForest/shaders/draw.cs.glsl" ).shaderHandle;
			shaders[ "Bounds" ] = computeShader( "./src/projects/Impostors/ChorizoForest/shaders/bounds.cs.glsl" ).shaderHandle;
			shaders[ "Animate" ] = computeShader( "./src/projects/Impostors/ChorizoForest/shaders/animate.cs.glsl" ).shaderHandle;

			// setup raster shaders
			shaders[ "Bounding Box" ] = regularShader(
				"./src/projects/Impostors/ChorizoForest/shaders/bbox.vs.glsl",
				"./src/projects/Impostors/ChorizoForest/shaders/bbox.fs.glsl"
			).shaderHandle;
			shaders[ "Point Sprite" ] = regularShader(
				"./src/projects/Impostors/ChorizoForest/shaders/pointSprite.vs.glsl",
				"./src/projects/Impostors/ChorizoForest/shaders/pointSprite.fs.glsl"
			).shaderHandle;
